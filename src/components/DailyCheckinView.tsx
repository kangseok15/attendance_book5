              ...
              {isEditingReason && userRole !== 'teacher' ? (
                <div className="mt-1 pt-1 flex items-center gap-1.5">
                  ...
                  <button
                    ...
                    className="px-2.5 py-1 text-xs rounded-lg bg-indigo-600 text-white font-bold hover:bg-indigo-700"
                  >
                    저장
                  </button>
                  <button
                    onClick={() => setEditingReasonId(null)}
                    className="px-2.5 py-1 text-xs rounded-lg border border-slate-300 text-slate-500 hover:bg-slate-100"
                  >
                    취소
                  </button>
                </div>
